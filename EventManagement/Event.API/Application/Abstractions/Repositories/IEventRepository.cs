...
namespace Eventbox.EventManagement.EventApi.Application.Abstractions.Repositories
{
    public interface IEventRepository : IRepository<Domains.Event, Guid>
    {
        ...
        Task<Domains.Event?> GetByOrganizationAsync(Guid organizationId, Guid eventId, bool includeSeats = false, bool asNoTracking = true, CancellationToken cancellationToken = default);
